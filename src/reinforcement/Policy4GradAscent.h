/*
 * Parallel *RECURRENT* Policy maximizer (gradient ascent) 
...
#ifndef __whiteice__Policy4GradAscent_h
#define __whiteice__Policy4GradAscent_h
...
namespace whiteice
{
  ...
  extern template class Policy4GradAscent< whiteice::math::blas_real<float> >;
  extern template class Policy4GradAscent< whiteice::math::blas_real<double> >;
};
