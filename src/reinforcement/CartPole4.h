...
#ifndef __whiteice__cartpole4_h
#define __whiteice__cartpole4_h
...
namespace whiteice
{
  ...
  template <typename T>
    class CartPole4 : public RIFL_abstract4<T>
    {
    public:
      CartPole4();
      ~CartPole4();
  ...
  extern template class CartPole4< math::blas_real<float> >;
  extern template class CartPole4< math::blas_real<double> >;
};
