...
{
  printf("REINFORCEMENT (CONTINUOS) LEARNING TESTCASES 4.2. (CartPole4 problem)\n");
  fflush(stdout);
...
#ifndef USE_SDL
  whiteice::logging.setOutputFile("cartpole4.log");
#endif
  ...
  if(useFlag == false){
    whiteice::CartPole4< whiteice::math::blas_real<double> > system;
